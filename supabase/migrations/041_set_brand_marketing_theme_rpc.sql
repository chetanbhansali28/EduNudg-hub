-- Platform RPC to set brand marketing theme (includes spark-academy constraint).
...
BEGIN
  ...
  IF p_theme IS NULL OR p_theme NOT IN ('novu', 'abacus-classic', 'spark-academy') THEN
...
-- Center landing passthrough (from 040; idempotent if already applied).
