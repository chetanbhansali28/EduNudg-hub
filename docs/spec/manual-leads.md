...
- Center: **Leads** — **+ Add Lead** opens the same modal (grouped Parent / Child / Location / Notes); **Import CSV** for bulk walk-in/phone enquiries; **Convert all eligible** for open leads with parent + child names
