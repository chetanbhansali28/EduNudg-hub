...
- Franchise Centers (`/app/centers`) — edit existing (including Franchise Identity login email/password for center portal); new centers via franchise application approval or **Import Franchise** CSV (same RPC as platform)
