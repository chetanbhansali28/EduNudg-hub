...
- Franchise Centers (`/app/centers`) — edit existing (including Franchise Identity login email/password for center portal); new centers via franchise application approval only
