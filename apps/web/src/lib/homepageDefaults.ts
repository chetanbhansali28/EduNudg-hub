...
export const DEFAULT_HOMEPAGE_CONFIG: HomepageConfig = {
  ...
  ecosystemIntro: {
    ...
    subtitle: "Hobby classes that feel personal — even when you run twenty centers.",
  },
  connectivityShowcase: {
    title: "From trial class to proud parent",
    subtitle: "Enrollment, progress, and communication stay connected for every child.",
    ...
    cards: [
      {
        ...
        iconKey: "how_to_reg",
        title: "Easy enroll",
        body: "Trials and admissions without paperwork piles",
      },
      {
        id: "rhythm",
        iconKey: "event_available",
        title: "Class rhythm",
        body: "Batches and attendance centers can trust",
      },
      {
        id: "progress",
        iconKey: "trending_up",
        title: "Visible progress",
        body: "What each child practiced this week",
      },
      {
        id: "close",
        iconKey: "chat",
        title: "Stay close",
        body: "WhatsApp updates parents actually read",
      },
    ],
  },
  brandSignup: {
